...
class LoginForm {
  ...
  Widget buildForm(BuildContext context, LoginBloc bloc, LoginBlocState state) {
    return Form(
      key: _formKey,
      child: Column(
            ...
            child: Row(
              ...
              children: [
                Container(
                    ...
                    child: state is LoginLoading ? CircularProgressIndicator() : MaterialButton(
                      elevation: 5,
                      onPressed: () {
                        if (_formKey.currentState.validate()) {
                          // email ok eve.holt@reqres.in
                          bloc.add(LoginSubmit(email: _emailController.text, password: _passwordController.text));
                        }
                      },
                      color: state is LoginSuccess ? Constants.GREEN : Constants.BLUE,
                      child: Icon(
                        Icons.pets,
                        size: 40,
                      ),
